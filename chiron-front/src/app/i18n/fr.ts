...
export const fr: Record<string, string> = {
  ...
  'course.voiceVolumeHint':
    "Part du volume média maximal du téléphone. Chiron le pousse le temps de sa phrase, puis le rend tel qu'il était. Déplace le curseur pour l'entendre.",
