...
export const en: Record<string, string> = {
  ...
  'journal.showTrace': 'Show the track',
  'journal.hideTrace': 'Hide the track',
  'journal.traceError': 'Track unavailable right now.',
  ...
  'exCard.courseStart': 'Start the run',
  'exCard.courseRestart': 'Run again',
  'exCard.courseTracked': 'GPS-tracked run — distance, duration and pace are measured.',
  ...
  'course.elevation': 'Elev. (m)',
  'course.splits': 'Kilometre splits',
  'course.km': 'Km {{km}}',
  'course.trace': 'Track',
  'course.listen': 'Give a voice command',
  'course.gpsSearching': 'Looking for a GPS signal…',
  'course.gpsAccuracy': 'GPS ±{{metres}} m',
  'course.gpsLost': 'GPS signal lost',
  'course.gpsError': 'GPS unavailable',
  'course.saving': 'Saving the track…',
  'course.saveError': 'The track could not be saved',
  'course.retry': 'Try again',
  'course.backToSession': 'Back to session',
  'course.confirmLeave':
  ...
  'course.say.target': 'Target pace: | {{cible}} per kilometre.',
  ...
  'tresor.selectTime': 'Select your time',
  'tresor.chrono': 'Time',
  'tresor.pace': 'Pace',
  'tresor.speed': 'Speed',
  'tresor.averageSpeed': 'Average speed',
  'tresor.minutes': 'Minutes',
  'tresor.seconds': 'Seconds',
  'tresor.scale': 'Scale',
