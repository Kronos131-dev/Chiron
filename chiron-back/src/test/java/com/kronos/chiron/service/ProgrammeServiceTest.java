...
class ProgrammeServiceTest {
    ...
    void sauvegarderProgramme_newProgramme_savesWithOwner() {
        ...
        SeanceDto dto = new SeanceDto(null, "Leg Day", LocalDateTime.now(), null, 1, false, null,
                List.of(new ExerciceDto(null, "Squat", null, null,
                        List.of(new SerieDto(100.0, 5, null, null)), null, null)));
    ...
    void sauvegarderProgramme_updateExisting_assignsDisplayOrderFromDtoPosition() {
        ...
        SeanceDto dto = new SeanceDto(7L, "Push", null, null, null, false, null,
                List.of(
                        new ExerciceDto(null, "Dips",  null, null, List.of(), null, null),
                        new ExerciceDto(null, "Bench", null, null, List.of(), null, null),
                        new ExerciceDto(null, "Squat", null, null, List.of(), null, null)
                ));
