...
public class SettingsController {
    ...
    public ResponseEntity<Void> changeEmail(
        ...
        settingsService.changeEmail(userDetails.getUsername(), request.currentPassword(), request.newEmail());
        return ResponseEntity.ok().build();
    }
    ...
    public ResponseEntity<AuthenticationResponse> changeUsername(
        ...
        String newToken = settingsService.changeUsername(
                userDetails.getUsername(), request.currentPassword(), request.newUsername());
