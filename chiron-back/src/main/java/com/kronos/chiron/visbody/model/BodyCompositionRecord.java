...
public class BodyCompositionRecord {
    ...
    @Column(name = "age_metabolique")
    private Double ageMetabolique;
    @Column(name = "graisse_viscerale")
    private Double graisseViscerale;
    @Column(name = "eau_totale")
    private Double eauTotale;
    @Column(name = "eau_intra")
    private Double eauIntra;
    @Column(name = "eau_extra")
    private Double eauExtra;
    @Column(name = "ratio_ecw_tbw")
    private Double ratioEcwTbw;
    @Column(name = "masse_proteine")
    private Double masseProteine;
    @Column(name = "sel_inorganique")
    private Double selInorganique;

    @Column(name = "mgc_bras_gauche")
    private Double mgcBrasGauche;
    @Column(name = "mgc_bras_droit")
    private Double mgcBrasDroit;
    @Column(name = "mgc_tronc")
    private Double mgcTronc;
    @Column(name = "mgc_jambe_gauche")
    private Double mgcJambeGauche;
    @Column(name = "mgc_jambe_droite")
    private Double mgcJambeDroite;

    @Column(name = "muscle_bras_gauche")
    private Double muscleBrasGauche;
    @Column(name = "muscle_bras_droit")
    private Double muscleBrasDroit;
    @Column(name = "muscle_tronc")
    private Double muscleTronc;
    @Column(name = "muscle_jambe_gauche")
    private Double muscleJambeGauche;
    @Column(name = "muscle_jambe_droite")
